...
class AppSettings {
  /// Basic Settings
  static const String applicationName = 'Platsafqat';
  static const String andoidPackageName = 'com.platsafqat.ahgh';
  ...
  ///API Setting
  static const String hostUrl = "https://admin.platsafqat.com/";
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  static const String deepLinkName = "platsafqat"; //deeplink demo.com
